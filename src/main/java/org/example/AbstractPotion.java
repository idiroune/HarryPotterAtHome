        ...
        if(wizard.getPotions().isEmpty()){
            ...
            if (scanner.hasNextInt()) {
                ...
                if (choix > 0 && choix <= wizard.getPotions().size()) {
                    ...
                    switch (potion) {
                        case "Potion de soin" -> wizard.setWizardHealth(wizard.getWizardHealth() + (healthPotion * wizard.getPotionEfficacity()));
                        case "Potion de force" -> wizard.setWizardDamage(wizard.getWizardDamage() + (damagePotion * wizard.getPotionEfficacity()));
                        case "Potion de precision" -> wizard.setWizardAccuracy(wizard.getWizardAccuracy() + (accuracyPotion * wizard.getPotionEfficacity()));
                    }
                } else {
